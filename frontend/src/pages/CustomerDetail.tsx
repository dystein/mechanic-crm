...
const CustomerDetail: FunctionComponent = () => {
  ...
  const onButtonIcon22Click = useCallback(() => {
    navigate("/customers");
  }, [navigate]);

  return (
    <>
      <div className="w-full relative bg-grey-grey-10 h-[910px] overflow-hidden text-left text-sm text-primary-white font-heading-h5-bold">
        <ScreenColumnsBG
          showRightArea
        ...
        <div className="absolute w-[calc(100%_-_90px)] top-[90px] right-[0px] left-[90px] flex flex-row items-start justify-start">
          <div className="flex-1 h-[670px] overflow-hidden flex flex-col items-center justify-start p-6 box-border gap-[24px]">
            <div className="self-stretch relative rounded-xl h-[200px] overflow-hidden shrink-0">
              ...
              <div className="absolute top-[76px] left-[24px] w-[100px] h-[100px] overflow-hidden">
                <div className="absolute h-full w-full top-[0px] right-[0px] bottom-[0px] left-[0px] rounded-31xl bg-primary-white overflow-hidden">
                  <div className="absolute h-full w-full top-[0px] right-[0px] bottom-[0px] left-[0px] rounded-31xl bg-primary-white" />
                </div>
                <img
                ...
                />
                <div className="absolute h-full w-full top-[0px] right-[0px] bottom-[0px] left-[0px] overflow-hidden opacity-[0]" />
              </div>
              <div
          ...
          <div className="w-[417px] bg-grey-grey-20 flex flex-col items-center justify-start text-lg text-primary-navy">
            <div className="w-[417px] flex flex-col items-start justify-start gap-[4px]">
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[4px] text-base text-grey-grey-90">
                <div
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start">
                    <div className="self-stretch h-[27px] overflow-hidden shrink-0 flex flex-row items-start justify-start gap-[5px]">
                    ...
                    <div className="self-stretch h-[27px] overflow-hidden shrink-0 flex flex-row items-start justify-start gap-[12px] text-sm text-grey-grey-70">
                ...
                <div className="w-[417px] overflow-hidden flex flex-row items-center justify-start py-[9px] px-6 box-border gap-[16px]">
                  <img
