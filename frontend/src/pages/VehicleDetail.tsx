...
const VehicleDetail: FunctionComponent = () => {
  ...
  return (
    <>
      <div
          className="w-full relative bg-grey-grey-10 h-[1116px] text-left text-sm text-grey-grey-70 font-heading-h5-bold">
        <ScreenColumnsBG
            showRightArea
        ...
        <div
          ...
          <div className="flex-1 overflow-hidden flex flex-col items-start justify-start">
            <div className="self-stretch flex flex-row items-start justify-start p-6 gap-[24px]">
              <div className="flex-1 relative h-[60px] overflow-hidden">
                <div className="absolute top-[8px] left-[0px] rounded-6xl w-11 h-11 overflow-hidden">
                  <div
                      className="absolute h-full w-full top-[0px] right-[0px] bottom-[0px] left-[0px] rounded-6xl bg-grey-grey-30"/>
                </div>
                <div className="absolute top-[0px] left-[64px] leading-[30px]">
                  Customer
                </div>
                <div
                    className="absolute top-[30px] left-[64px] flex flex-row items-start justify-start gap-[5px] text-base text-grey-grey-90">
            ...
            />
            <div
                className="self-stretch bg-primary-white flex flex-row items-center justify-start p-6 gap-[24px] text-9xl text-primary-navy">
              ...
              <div className="flex-1 flex flex-col items-start justify-start gap-[40px]">
                ...
                <div className="self-stretch flex flex-row items-start justify-start gap-[24px]">
                  <div className="flex-1 relative h-[60px]">
                    ...
                    <div
                        className="absolute top-[30px] left-[0px] flex flex-row items-center justify-start text-base text-grey-grey-90">
                ...
                <div className="self-stretch flex flex-row items-start justify-start gap-[24px]">
                  <div className="flex-1 relative h-[60px]">
                    ...
                    <div
                        className="absolute top-[30px] left-[0px] flex flex-row items-start justify-start gap-[2px] text-base text-grey-grey-90">
          ...
          <div
              className="w-[417px] bg-grey-grey-20 overflow-hidden shrink-0 flex flex-col items-center justify-start text-lg text-primary-navy">
            <div className="self-stretch overflow-hidden flex flex-col items-center justify-start p-6">
              <div
                  className="self-stretch rounded-xl bg-primary-white overflow-hidden flex flex-col items-start justify-start border-[1px] border-solid border-grey-grey-30">
                ...
                <div
                    className="self-stretch overflow-hidden flex flex-col items-start justify-start py-3 px-6 gap-[24px] text-base">
                  <LabelYes
                      label="Description"
                      icon="/icon15.svg"
                  ...
                  <div className="self-stretch overflow-hidden flex flex-col items-start justify-start gap-[12px]">
                    ...
                    <div
                        className="self-stretch rounded-lg bg-grey-grey-10 overflow-hidden flex flex-col items-center justify-center p-2 text-center text-grey-grey-70 border-[1px] border-solid border-grey-grey-30">
            ...
            <div className="self-stretch overflow-hidden flex flex-col items-center justify-start">
              ...
              <div
                  className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-6 gap-[24px] text-sm text-grey-grey-70">
                <div className="self-stretch flex flex-row items-start justify-start py-0 pr-6 pl-3 gap-[12px]">
                  <div className="w-[54px] relative h-[54px] overflow-hidden shrink-0">
                    <div
                        className="absolute top-[11px] left-[11px] rounded-81xl bg-primary-white box-border w-8 h-8 overflow-hidden border-[11px] border-solid border-gold-200"/>
                  </div>
                  <div className="flex-1 flex flex-col items-start justify-start gap-[12px]">
                    ...
                    <div
                        className="self-stretch bg-primary-white overflow-hidden flex flex-col items-center justify-center">
                      <img
                ...
                <div className="self-stretch flex flex-row items-start justify-start gap-[11px]">
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start gap-[12px]">
                    ...
                    <div
                        className="w-[150px] rounded-xl h-[100px] overflow-hidden shrink-0 hidden flex-row items-start justify-start">
                      <img
                ...
                <div
                    className="self-stretch overflow-hidden flex flex-row items-center justify-center py-[9px] pr-3.5 pl-6 text-right text-olive">
