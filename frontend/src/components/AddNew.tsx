...
const AddNew: FunctionComponent<ChoicePopupProps> = ({
  ...
  return (
    <div
      className="w-[1366px] bg-black-black-50 h-[910px] overflow-hidden max-w-full max-h-full text-left text-sm text-primary-navy font-heading-h5-bold"
    ...
    >
      <div className="absolute top-[calc(50%_-_77px)] left-[calc(50%_-_120px)] rounded-xl bg-primary-white w-60 overflow-hidden flex flex-col items-start justify-start">
        <div className="self-stretch relative bg-primary-white h-[50px] overflow-hidden shrink-0 text-grey-grey-70">
          ...
          <img
            className="hover:cursor-pointer absolute top-[calc(50%_-_25px)] right-[0px] rounded-31xl w-[50px] h-[50px] overflow-hidden"
            alt=""
            src="/button8.svg"
            onClick={onClose}
          />
        ...
        />
        <div
          className="hover:cursor-pointer self-stretch bg-primary-white overflow-hidden flex flex-row items-center justify-start py-2.5 px-[15px] gap-[15px]"
